...
public class BookEntry extends Grid {
    ...
    public BookEntry(String title, double price, int amount, boolean on_order, AlterBookEvent handler) {
        this.handler = handler;
        this.book_title = title;
        this.title_label = new Label(String.format("<big>%s</big>", title));
        ...
        this.price_label = new Label(String.format("<b>%1$.2f €</b>", price));
        this.price_label.setUseMarkup(true);
        ...
        this.button = new ImageButton((on_order ? ActionIcon.LIST_REMOVE : ActionIcon.LIST_ADD), IconSize.LARGE_TOOLBAR, title,
